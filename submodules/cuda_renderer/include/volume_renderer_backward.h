#ifndef VOLUME_RENDERER_BACKWARD_H
#define VOLUME_RENDERER_BACKWARD_H
 ...
 * 
 * This is the adjoint/backward operator for the render_rays forward pass.
 * 
 * Mathematical details in BACKWARD_PASS_DERIVATION.md
 */
std::tuple<
